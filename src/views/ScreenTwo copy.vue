  ...
  <div class="container">
    ...
    <div class="main" :style="{height:mainheight+'px'}">
      <div
        ...
        :key="v.id"
        :style="{width:v.width*mainwidth/100-22+'px',height:v.height*mainheight/100-22+'px',left:v.x*mainwidth/100+'px',top:v.y*mainheight/100+'px'}"
      >
    ...
    <div class="foot">
      <el-button type="primary" v-if="isShow" @click="saveScreen">保存</el-button>
      <el-button type="default" v-if="isShow" @click="cancelScreen">取消</el-button>
    </div>
  </div>
</template>
  ...
  computed: {
    ...
    title() {
      if (this.$store.state.screenList.length) {
        return this.$store.state.screenList[0].title;
      }
    },
    moduleList() {
      if (this.$store.state.screenList.length) {
        return this.$store.state.screenList[0].moduleList;
      }
    },
    isShow() {
